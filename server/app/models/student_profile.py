...
class StudentProfile(Base):
    ...
    minimum_gpa_preference: Mapped[Decimal] = mapped_column(Numeric(2, 1), default=Decimal("1.0"), nullable=False)
    maximum_gpa_preference: Mapped[Decimal] = mapped_column(Numeric(2, 1), default=Decimal("4.0"), nullable=False)
    ...
    recommendation_profile_version: Mapped[str | None] = mapped_column(String(64), nullable=True)
    recommendation_status: Mapped[str] = mapped_column(String(20), default="pending", nullable=False)
    recommendation_error: Mapped[str | None] = mapped_column(String(500), nullable=True)
    recommendations_generated_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
