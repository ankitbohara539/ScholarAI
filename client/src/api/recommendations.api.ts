...
export const recommendationsApi = {
  ...
  async simulate(data: SimulationInput, signal?: AbortSignal): Promise<RecommendationList> { return (await api.post<RecommendationList>('/student/recommendations/simulate', data, { signal })).data },
}
